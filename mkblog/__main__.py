...
from mkblog.commands import build, init, serve
...
def cli():
    """
    mkblogs - static blog site generator with Markdown.
    """
...
@common_options
def init_command(project_directory):
    """Initiate a new mkblog project"""
    init.init(project_directory)
